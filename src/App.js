...
class App extends Component {
  ...
  render() {
    // if (
    //   this.props.router.pathname.includes("blogger", "business") &&
    //   !this.props.router.pathname.includes(userRoleList[this.props.user.role])
    // ) {
    ...
    return (
      ...
      <Fragment>
        ...
        {/* <div>
            ...
            <Offline onChange={this.handleOffline}>offline</Offline>
        </div> */}
        <Detector
          render={({ online }) => (
